...
import 'package:flutter_shizhan/widget/expand_more_text_widget.dart';
...
class TopicDetailItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      // TODO:跳转 '/detail' 界面
      onTap: () => {
        print("资讯详情页列表被点击:${model.data.content.data.toJson()}"),
        toNamed('/detail', model.data.content.data),
      },
      child: Column(
